#!/usr/bin/env python
#
# {{ cookiecutter.package_name }} documentation build configuration file, created by sphinx-quickstart.
#
...
copyright = '2023, <a href="{{ cookiecutter.author_url }}">{{ cookiecutter.author }}</a>'
...
def linkcode_resolve(domain, info):
    ...
    if domain != "py" or not info["module"]:
        return None
    try:
        filename = "{{ cookiecutter.package_name }}/%s#L%d-L%d" % find_source()
    except Exception:
    ...
    return "https://github.com/{{ cookiecutter.github_username }}/{{ cookiecutter.github_repo_name }}/blob/%s/%s" % (tag, filename)
